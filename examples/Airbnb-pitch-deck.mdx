...
Prepare OpenAI-compatible document context for the pitch deck before running the schema-driven analysis.

```python
doc_msg = ...  # An object exposing `.openai_messages` and `.openai_responses_input`
```
...
<CodeGroup>
```python main.py
from retab.types.schemas.model import Schema
...
```go main.go
// Build the JSON schema directly as map[string]any in Go. The Retab API
// accepts the schema verbatim, including X-SystemPrompt and X-ReasoningPrompt
// annotations.
package main
...
func main() {
	schema := map[string]any{
		"type":           "object",
		"title":          "Deck",
		"X-SystemPrompt": "Your task is to extract structured information from pitch decks based on the provided schema...",
		"properties": map[string]any{
			"name":    map[string]any{"type": "string", "description": "Name of the company"},
			"website": map[string]any{"type": "string", "description": "URL of the company website"},
			"country": map[string]any{"type": "string", "description": "2 letter Country code of the company"},
			"investors": map[string]any{
				"type":              "object",
				"description":       "Existing investors in the startup",
				"X-ReasoningPrompt": "Think about the investors. Detail your thought process step by step.",
			},
			"competitors": map[string]any{
				"type":              "object",
				"description":       "Competitors identified by the startup in the deck",
				"X-ReasoningPrompt": "Walk through your analysis of the competitive landscape step by step.",
			},
			"clients": map[string]any{
				"type":              "object",
				"description":       "Clients (B2B) in pipe or signed by the startup in the deck",
				"X-ReasoningPrompt": "Break down your client analysis systematically.",
			},
			"team": map[string]any{
				"type":              "array",
				"description":       "Company Team",
				"X-ReasoningPrompt": "Analyze the team composition methodically.",
				"items": map[string]any{
					...
					"properties": map[string]any{
						...
						"pastExperiences": map[string]any{"type": "string"},
					},
				},
			},
			"businessModel": map[string]any{
				"type":              "string",
				"enum":              []string{"B2B", "B2C", "C2C"},
				"description":       "Business model of the startup",
				"X-ReasoningPrompt": "Explain your business model classification process step by step.",
			},
		},
		"required": []string{"name", "website", "country", "investors", "competitors", "clients", "team", "businessModel"},
	}
...
```ruby main.rb
# Build the JSON schema directly as a Ruby Hash. The Retab API accepts the
# schema verbatim, including X-SystemPrompt and X-ReasoningPrompt annotations.
require 'json'
...
schema = {
  ...
  'properties' => {
    ...
    'website' => { 'type' => 'string', 'description' => 'URL of the company website' },
    'country' => { 'type' => 'string', 'description' => '2 letter Country code of the company' },
    'investors' => {
      'type' => 'object',
      'description' => 'Existing investors in the startup',
      'X-ReasoningPrompt' => 'Think about the investors. Detail your thought process step by step.',
  ...
  'required' => ['name', 'website', 'country', 'investors', 'competitors', 'clients', 'team', 'businessModel'],
}
...
```php main.php
<?php
// Build the JSON schema directly as a PHP array. The Retab API accepts the
// schema verbatim, including X-SystemPrompt and X-ReasoningPrompt annotations.
$schema = [
    'type' => 'object',
    'title' => 'Deck',
...
```csharp main.cs
// Build the JSON schema directly as Dictionary<string, object>. The Retab API
// accepts the schema verbatim, including X-SystemPrompt and X-ReasoningPrompt
// annotations.
using System;
...
var schema = new Dictionary<string, object>
{
    ...
    ["properties"] = new Dictionary<string, object>
    {
        ...
        ["website"] = new Dictionary<string, object>
        {
            ["type"] = "string",
            ["description"] = "URL of the company website",
        },
        ...
        ["investors"] = new Dictionary<string, object>
        {
            ["type"] = "object",
            ["description"] = "Existing investors in the startup",
            ["X-ReasoningPrompt"] = "Think about the investors. Detail your thought process step by step.",
        },
        ["competitors"] = new Dictionary<string, object>
        {
            ["type"] = "object",
            ["description"] = "Competitors identified by the startup in the deck",
            ["X-ReasoningPrompt"] = "Walk through your analysis of the competitive landscape step by step.",
        ...
        ["team"] = new Dictionary<string, object>
        {
            ...
            ["items"] = new Dictionary<string, object>
            {
                ...
                ["properties"] = new Dictionary<string, object>
                {
                    ...
                    ["pastExperiences"] = new Dictionary<string, object> { ["type"] = "string" },
                },
            },
        },
        ["businessModel"] = new Dictionary<string, object>
        {
            ["type"] = "string",
            ["enum"] = new List<string> { "B2B", "B2C", "C2C" },
            ["description"] = "Business model of the startup",
            ["X-ReasoningPrompt"] = "Explain your business model classification process step by step.",
        },
    },
    ...
    {
        "name", "website", "country", "investors", "competitors", "clients", "team", "businessModel",
    },
};
...
const extraction = await client.extractions.create("airbnb_pitch_deck.pdf", schema, "retab-small");

console.log(extraction.output);
```

```rust Rust
use retab::{resources::extractions::CreateParams, Retab};

let client = Retab::new(std::env::var("RETAB_API_KEY")?);
let schema: std::collections::HashMap<String, serde_json::Value> =
...
let mut params = CreateParams::new("airbnb_pitch_deck.pdf", schema);
...
public final class Example {
  public static void main(String[] args) throws Exception {
    ...
    var result = client.extractions().create(null, null, "retab-1.5", "Extract the invoice fields", 10L, null, null, null, null, null, null, null);
...
extraction = client.extractions.create(
  ...
  json_schema: schema_obj_json,
  model: 'retab-small',
)

puts JSON.pretty_generate(extraction.output)
```
...
```csharp main.cs (Retab Extraction)
using System;
using System.IO;
using System.Text.Json;
using Retab;
...
var extraction = await client.Extractions.CreateAsync(
    ...
    {
        Document = new FileInfo("airbnb_pitch_deck.pdf"),
        JsonSchema = schema,
        Model = "retab-small",
    }
);
...
func main() {
	...
	model := "retab-small"
	extraction, err := client.Extractions.Create(context.Background(), &retab.ExtractionsCreateParams{
		Document:   "airbnb_pitch_deck.pdf",
		JSONSchema: schema,
		Model:      &model,
	})
...
REASONING_PREFIX = 'reasoning___'

def filter_auxiliary_fields_json(value)
  case value
  when Hash
    value.reject { |k, _| k.to_s.start_with?(REASONING_PREFIX) }
         .transform_values { |v| filter_auxiliary_fields_json(v) }
  when Array
    value.map { |v| filter_auxiliary_fields_json(v) }
  else
    value
  end
end

raw = JSON.parse(response_output_text)
extraction = filter_auxiliary_fields_json(raw)

puts JSON.pretty_generate(extraction)
```
...
const string ReasoningPrefix = "reasoning___";

static object? FilterAuxiliaryFields(object? value)
{
    return value switch
    {
        IDictionary<string, object?> map => map
            .Where(kv => !kv.Key.StartsWith(ReasoningPrefix))
            .ToDictionary(kv => kv.Key, kv => FilterAuxiliaryFields(kv.Value)),
        IEnumerable<object?> list when value is not string => list.Select(FilterAuxiliaryFields).ToList(),
        _ => value,
    };
}

var filtered = FilterAuxiliaryFields(extraction.Output);
...
doc_msg = ...  # An object exposing `.openai_messages`
...
doc_msg = ...  # An object exposing `.openai_responses_input`
...
schema = {
  ...
  'properties' => {
    ...
    'investors' => {
      'type' => 'object',
      'description' => 'Existing investors in the startup',
      'X-ReasoningPrompt' => "Think about the investors. Detail your thought process, and explain logically, step by step, who are the investors, detailing the cues and evidence for each one.",
      'properties' => {
        'name' => { 'type' => 'string' },
        'type' => { 'type' => 'string', 'enum' => ['school', 'investor', 'startup', 'corporate'] },
        'relationship' => { 'type' => 'string', 'enum' => ['founderBackground', 'investor', 'competitor', 'client', 'partnership'] },
      },
    ...
    'team' => {
      ...
      'items' => {
        'type' => 'object',
        'properties' => {
          'firstName' => { 'type' => 'string', 'description' => 'First name of the team member' },
          'lastName' => { 'type' => 'string', 'description' => 'Last name of the team member' },
          'title' => { 'type' => 'string', 'description' => 'Title, position of the team member' },
          'pastExperiences' => { 'type' => 'string', 'description' => 'Previous experiences' },
        },
        'required' => ['firstName', 'lastName', 'title', 'pastExperiences'],
      },
    },
    'businessModel' => {
      'type' => 'string',
...
# Eventually: filter the response to remove the reasoning fields
REASONING_PREFIX = 'reasoning___'
...
filtered = filter_auxiliary_fields_json(extraction.output)
...
var companyTypes = new List<string> { "school", "investor", "startup", "corporate" };
var companyRelations = new List<string>
{
    "founderBackground", "investor", "competitor", "client", "partnership",
};

Dictionary<string, object> CompanyProperty(string description, string reasoning) =>
    new()
    {
        ["type"] = "object",
        ["description"] = description,
        ["X-ReasoningPrompt"] = reasoning,
        ["properties"] = new Dictionary<string, object>
        {
            ["name"] = new Dictionary<string, object> { ["type"] = "string" },
            ["type"] = new Dictionary<string, object> { ["type"] = "string", ["enum"] = companyTypes },
            ["relationship"] = new Dictionary<string, object> { ["type"] = "string", ["enum"] = companyRelations },
        },
        ["required"] = new List<string> { "name", "type", "relationship" },
    };
...
var schema = new Dictionary<string, object>
{
    ["type"] = "object",
    ["title"] = "Deck",
    ["X-SystemPrompt"] = systemPrompt,
    ["properties"] = new Dictionary<string, object>
    {
        ["name"] = new Dictionary<string, object> { ["type"] = "string", ["description"] = "Name of the company" },
        ["website"] = new Dictionary<string, object> { ["type"] = "string", ["description"] = "URL of the company website" },
        ["country"] = new Dictionary<string, object> { ["type"] = "string", ["description"] = "2 letter Country code of the company" },
        ["investors"] = CompanyProperty(
            "Existing investors in the startup",
            "Think about the investors. Detail your thought process step by step."),
        ["competitors"] = CompanyProperty(
            "Competitors identified by the startup in the deck",
            "Walk through your analysis of the competitive landscape step by step."),
        ["clients"] = CompanyProperty(
            "Clients (B2B) in pipe or signed by the startup in the deck",
            "Break down your client analysis systematically."),
        ["team"] = new Dictionary<string, object>
        {
            ["type"] = "array",
            ["description"] = "Company Team",
            ...
            ["items"] = new Dictionary<string, object>
            {
                ...
                ["properties"] = new Dictionary<string, object>
                {
                    ["firstName"] = new Dictionary<string, object> { ["type"] = "string", ["description"] = "First name of the team member" },
                    ["lastName"] = new Dictionary<string, object> { ["type"] = "string", ["description"] = "Last name of the team member" },
                    ["title"] = new Dictionary<string, object> { ["type"] = "string", ["description"] = "Title, position of the team member" },
                    ["pastExperiences"] = new Dictionary<string, object> { ["type"] = "string", ["description"] = "Previous experiences" },
                },
                ["required"] = new List<string> { "firstName", "lastName", "title", "pastExperiences" },
            },
        },
        ["businessModel"] = new Dictionary<string, object>
        {
