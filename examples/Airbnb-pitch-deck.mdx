...
- A [airbnb_pitch_deck.pdf](https://github.com/UiForm/uiform/blob/main/notebooks/airbnb/airbnb_pitch_deck.pdf) file in the same directory as the `main.py` file 
...
```bash
wget https://github.com/UiForm/uiform/blob/main/notebooks/airbnb/airbnb_pitch_deck.pdf
```
