...
public final class Example {
  public static void main(String[] args) throws Exception {
    ...
    var result = client.parses().create(null, "retab-1.5", null, "Extract the invoice fields", null, null, null);
...
When Retab processes visual documents, parse and extraction resources include image-rendering metadata so you can inspect how the document was processed.
