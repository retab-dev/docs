...
Use pre-defined templates for consistent form filling without re-detecting fields each time.
...
# Use a pre-defined template instead of providing a document
# The template contains the empty PDF and pre-defined form fields
result = client.documents.edit(
    template_id="tmpl_abc123",  # Your template ID
    filling_instructions="""
    Full Name: Jane Smith
    Date of Birth: March 15, 1985
    Email: jane.smith@example.com
...
- Avoid re-running OCR and field detection for each request
