...
An EditResponse object containing the filled PDF and form data.
  <Expandable title="properties">
    <ResponseField name="ocr_result" type="OCRResult Object">
      Raw OCR results including all detected text elements, their bounding boxes, and an annotated PDF (as MIMEData).
    </ResponseField>
    ...
    <ResponseField name="filled_pdf" type="MIMEData">
...
// Save the filled PDF
if (result.filled_pdf) {
    const base64Content = result.filled_pdf.url.split(",")[1];
