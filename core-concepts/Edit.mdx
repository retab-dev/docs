...
<ParamField body="model" type="LLMModel" default="gemini-2.5-pro">
  The AI model to use for element detection and filling. Recommended: `gemini-2.5-pro` for accuracy.
</ParamField>
...
### Model Selection
- **`gemini-2.5-pro`**: Most accurate for complex documents with many fields or ambiguous layouts. Recommended for production use.
- **`gemini-2.5-flash`**: Faster and more cost-effective, suitable for simple documents with clear field labels.
