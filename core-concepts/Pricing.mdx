...
- Model usage: 1 run × 0.5 credits = 0.5 credits
- **Total: 0.5 credits**
...
- Model usage: 1 run × 0.1 credits = 0.1 credits  
- **Total: 0.1 credits**
