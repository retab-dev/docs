...
<ParamField body="reasoning_effort" type="ChatCompletionReasoningEffort" default="minimal">
  The effort level for the model to reason about the input data. Defaults to "minimal".
</ParamField>

<ParamField body="parallel_ocr_keys" type="dict[str, str] | None" default="None">
