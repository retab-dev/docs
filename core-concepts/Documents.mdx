...
| **`split`** | Analyzes multi-page documents and classifies pages into user-defined subdocuments, returning page ranges for each section. Perfect for separating mixed document batches and organizing content by type. |
