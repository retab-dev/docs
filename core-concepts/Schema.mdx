...
const schema = await client.schemas.generate([
    "freight/booking_confirmation_1.jpg",
    "freight/booking_confirmation_2.jpg",
  ], "retab-small", "Capture shipment dates, parties, and reference numbers.", 192);
...
public final class Example {
  public static void main(String[] args) throws Exception {
    ...
    var result = client.schemas().generate(null, "retab-1.5", "Extract the invoice fields", 10L, null, null);
