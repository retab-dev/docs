...
<ParamField body="model" type="LLMModel" required>
  The AI model to use for document splitting. Recommended: `gemini-2.5-flash` for best balance of speed and accuracy.
</ParamField>
...
### Model Selection
- **`gemini-2.5-flash`**: Best balance of speed and accuracy for most use cases
- **`gemini-2.5-pro`**: Higher accuracy for complex or ambiguous documents
- **`gpt-4.1`**: Alternative for specific document types
