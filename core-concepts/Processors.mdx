...
<ResponseField name="model" type="string">
  AI model used for extraction (e.g., `"gpt-5.4"`, `"gpt-5.4"`, `"claude-3-5-sonnet"`).
</ResponseField>
...
```go Request
// The Go SDK does not yet model the processors API. Use retab.InferMIMEData
// to build the document payload, then POST to /v1/processors/{id}/submit.
package main
