...
Structured generation will output JSON objects. To match these JSON objects with an internal database, we recommend you to use the Levenshtein distance. The steps are the following: 
<Steps>
