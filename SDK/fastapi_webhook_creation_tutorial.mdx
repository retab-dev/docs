...
UiForm handles all the document preprocessing.:
...
### Step 4: Create your automation and Test It
...
print("Details:", automation)
```

After setting up the automation, simulate or trigger an event that complies with your JSON schema. The automation will send a POST request to your FastAPI webhook endpoint, where the payload can be processed.

### Step 5

Finally, you can test the automation with the test functions of the sdk: 
...
- **Automation Creation:** Connects your webhook to the broader integration, ensuring that events trigger the desired actions.

You now have a complete integration framework linking your FastAPI backend to your automation workflow. This setup allows you to efficiently process and respond to incoming events.
