...
<Steps>
  ...
  <Step title="Create a Next.js app">
    Create a Next.js app with a UIForm component from your json schema.
  </Step>
...
NEXT_PUBLIC_API_URL=http://localhost:3000/api                 # Your Next.js API route
  ```
...
```javascript app/page.tsx  {7, 11,13-29}
'use client'
...
Check the repository for the full code: [https://github.com/uiform/ui-form-nextjs-example](https://github.com/getcube/ui-form-nextjs-example)


<CodeGroup>
```jsx app/page.tsx {38-53}
'use client'
