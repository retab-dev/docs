...
deployment = uiclient.processors.automations.mailboxes.create(
...
You can see the deployment you just created on your [dashboard](https://www.uiform.com/dashboard/processors) !
...
You can also test your deployment directly from the [dashboard](https://www.uiform.com/dashboard/processors):
<Frame>
