...
Save this [JSON Schema](https://github.com/UiForm/examples/blob/main/nextjs-quickstart/schema.json) as `json_schema.json`

Download this [example document](https://github.com/UiForm/examples/blob/main/nextjs-quickstart/example.jpg) as `example.jpg`
