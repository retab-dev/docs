...
curl --request POST \
  --url https://api.retab.dev/v1/emails/tests/webhook \
...
For high-volume applications, we can provide a dedicated plan. [Contact us](mailto:contact@retab.dev) for more information.
