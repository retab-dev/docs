...
<CodeGroup>
```python Request
invoice_eval = client.evals.get(id = "eval_01HZX4H9Q0J2M4P1ZS6E6FY8MN")
```
</CodeGroup>
...
<CodeGroup>
```python Request
client.evals.delete("eval_01HZX4H9Q0J2M4P1ZS6E6FY8MN")
```
</CodeGroup>
...
sales_invoice = client.evals.documents.create(
  eval_id="eval_01HZX4H9Q0J2M4P1ZS6E6FY8MN",
...
<CodeGroup>
```python Request
docs = client.evals.documents.list(eval_id="eval_01HZX4H9Q0J2M4P1ZS6E6FY8MN")
```
```json Response
...
<CodeGroup>
```python Request
client.evals.documents.delete(eval_id="eval_4988392", id="doc_f7c8…")
```
```json Response
...
<CodeGroup>
```python Request
iters = client.evals.iterations.list(eval_id="eval_…")
```
```json Response
{ "data": [ {"id": "iter_…"}, … ] }
```
...
<CodeGroup>
```python Request
client.evals.iterations.delete("iter_01HZ…")
```
```json Response
