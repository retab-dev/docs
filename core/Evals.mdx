...
In this section, we will see how to use the methods of the `client.evals` module. Please check the [API Reference](https://docs.retab.dev/api-reference/evals/create) for more details.
