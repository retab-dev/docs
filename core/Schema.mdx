In this section, we will see how to use the methods of the client.schemas module. Please check the [API Reference](https://docs.uiform.com/api-reference/schema/generate) for more details.
...
data = filter_reasoning_fields_json(response.choices[0].message.content)
...
| **Post-process**       | `filter_reasoning_fields_json()`                   | Remove the reasoning keys.                                      |
