...
if (result.Output.FilledDocument != null)
{
    ...
    await File.WriteAllBytesAsync("filled-application.pdf", filledBytes);
...
var template = await client.EditTemplates.CreateAsync(
    client.ApiKey,
...
if (result.Output.FilledDocument != null)
{
    var dataUrl = result.Output.FilledDocument.Url;
    var base64Content = dataUrl.Split(',', 2)[1];
    await File.WriteAllBytesAsync("filled-from-template.pdf", Convert.FromBase64String(base64Content));
...
";
    ...
    if (result.Output.FilledDocument != null)
    {
        ...
        await File.WriteAllBytesAsync(outputFilename, Convert.FromBase64String(base64Content));
...
{
    var base64Content = result.Output.FilledDocument.Url.Split(',', 2)[1];
    await File.WriteAllBytesAsync("filled-contract.docx", Convert.FromBase64String(base64Content));
...
{
    var base64Content = result.Output.FilledDocument.Url.Split(',', 2)[1];
    await File.WriteAllBytesAsync("filled-invoice.xlsx", Convert.FromBase64String(base64Content));
...
{
    var base64Content = result.Output.FilledDocument.Url.Split(',', 2)[1];
    await File.WriteAllBytesAsync("filled-sales-deck.pptx", Convert.FromBase64String(base64Content));
