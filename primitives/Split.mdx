...
func main() {
	...
	model := "retab-small"
	nConsensus := 3
	propertyDescription := "Property listing pages with photos, pricing, and listing details"
	allowMultipleInstances := true
	legalNoticeDescription := "Legal notices, disclaimers, or policy pages"
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for split in result.output.as_ref().unwrap() {
...
func main() {
	...
	coverLetterDescription := "Cover letters or transmittal documents"
	subdocuments := []*retab.Subdocument{
		...
		{Name: "cover_letter", Description: &coverLetterDescription},
	}
