...
const parse = await client.parses.create('technical-manual.pdf', 'retab-small', 'markdown', 192);
...
const parse: Parse = await client.parses.create("technical-manual.pdf", "retab-small", "markdown", 192);
