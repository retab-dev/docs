...
Create a new workflow. The workflow is created unpublished, with a default `start` block at canvas position `(0, 0)`. Use the [Blocks](/api-reference/workflows/blocks/create) and [Edges](/api-reference/workflows/edges/create) endpoints to build out the graph, then [Publish](/api-reference/workflows/publish) when you're ready to run it.
