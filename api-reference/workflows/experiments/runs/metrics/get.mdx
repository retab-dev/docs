...
```bash curl
curl -X 'GET' \
  'https://api.retab.com/v1/workflows/experiments/runs/exprun_2/metrics?view=summary' \
  -H 'Api-Key: <your-api-key>'

curl -X 'GET' \
  'https://api.retab.com/v1/workflows/experiments/runs/exprun_2/metrics?view=by_target&target_path=total' \
  -H 'Api-Key: <your-api-key>'
```
