...
Publish the workflow's current draft as a new immutable version. New runs created via [Run Workflow](/api-reference/workflows/runs/create), email triggers, schedules, or webhooks always execute against the latest published version — edits to the draft after publish do not affect in-flight or future runs until you publish again.
