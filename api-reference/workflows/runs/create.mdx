...
document = MIMEData(
    ...
    url="https://storage.retab.com/org_abc/file_abc123.pdf",
)
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let document = MimeData::new(
        "invoice.pdf",
        "https://storage.retab.com/org_abc/file_abc123.pdf",
    );
...
var result = await client.Workflows.Runs.CreateAsync(
    new WorkflowRunsCreateOptions
    {
        ...
        {
            ["start_document-block-1"] = MimeData.FromUrl(new Uri("https://storage.retab.com/org_abc/file_abc123.pdf")),
        },
    }
);
