...
export = client.workflow_runs.export(
  workflow_id: 'wf_abc123xyz',
  block_id: 'extract-1',
  export_source: 'outputs',
  status: 'completed',
...
$result = $client->workflowRuns()->export(
...
var result = await client.WorkflowRuns.ExportAsync(apiKey, new WorkflowRunsExportOptions());
