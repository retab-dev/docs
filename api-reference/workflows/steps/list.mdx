---
title: "List Steps"
openapi: "GET /v1/workflows/steps?run_id={run_id}"
---
...
const steps = await client.workflows.steps.list("run_abc123xyz");
...
func main() {
	...
	steps, err := client.Workflows.Steps.List(ctx, "run_abc123xyz")
	if err != nil {
		log.Fatal(err)
	}
