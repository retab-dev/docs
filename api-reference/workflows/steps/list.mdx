...
func main() {
	...
	steps, err := client.Workflows.Steps.List(ctx, "run_abc123xyz", nil)
	if err != nil {
		log.Fatal(err)
	}
...
steps = client.workflow_steps.list(run_id: 'run_abc123xyz')
...
var result = await client.WorkflowSteps.ListAsync(apiKey, new WorkflowStepsListOptions());
