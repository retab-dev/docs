...
schema-drift state, latest run summaries). Use this to populate a Evals page or
...
tests = client.workflows.evals.list(
...
const tests = await client.workflows.evals.list({
...
func main() {
	...
	// All evals for a workflow.
	tests, err := client.Workflows.Evals.List(ctx, &retab.WorkflowEvalsListParams{
		WorkflowID: "wf_abc123xyz",
...
public final class Example {
  public static void main(String[] args) throws Exception {
    ...
    var result = client.workflows().evals().list("wf_abc123", null, null, null, 10L, null);
