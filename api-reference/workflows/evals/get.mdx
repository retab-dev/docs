...
test = client.workflows.evals.get(
...
const test = await client.workflows.evals.get("wfnodeeval_hsLEQiM61ez9Piv147MWk");
...
func main() {
	...
	test, err := client.Workflows.Evals.Get(ctx, "wfnodeeval_hsLEQiM61ez9Piv147MWk")
	if err != nil {
		log.Fatal(err)
	}
...
test = client.workflows.evals.get(eval_id: 'wfnodeeval_hsLEQiM61ez9Piv147MWk')
...
public final class Example {
  public static void main(String[] args) throws Exception {
    ...
    var result = client.workflows().evals().get("eval_abc123");
