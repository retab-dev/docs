---
title: "Update Block"
openapi: "PATCH /v1/workflows/blocks/{block_id}?workflow_id={workflow_id}"
---
...
func main() {
	...
	block, err := client.Workflows.Blocks.Update(ctx, "wf_abc123xyz", "extract-1", retab.WorkflowBlockUpdateRequest{
		Label:     &label,
		PositionX: &positionX,
		PositionY: &positionY,
	})
