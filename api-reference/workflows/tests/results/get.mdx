...
var result = await client.Workflows.Tests.Results.GetAsync("result_abc123");
...
public final class Example {
  public static void main(String[] args) throws Exception {
    ...
    var result = client.workflows().tests().results().get("result_abc123");
