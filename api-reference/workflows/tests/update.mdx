...
openapi: "PATCH /v1/workflows/tests/{test_id}?workflow_id={workflow_id}"
---
...
# Rename only
curl -X 'PATCH' \
  'https://api.retab.com/v1/workflows/tests/wfnodetest_hsLEQiM61ez9Piv147MWk?workflow_id=wf_abc123xyz' \
