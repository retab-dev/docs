...
func main() {
	...
	// Rename only.
	if _, err := client.Workflows.Tests.Update(ctx, testID, &retab.WorkflowTestsUpdateParams{
	...
	// Re-capture inputs from a different run.
	if _, err := client.Workflows.Tests.Update(ctx, testID, &retab.WorkflowTestsUpdateParams{
		Source: ptr(retab.WorkflowTestSourceFromManualWorkflowTestSource(retab.ManualWorkflowTestSource{
			Type: ptr("manual"),
		})),
	}); err != nil {
		log.Fatal(err)
...
var result = await client.Workflows.Tests.UpdateAsync("test_abc123", new WorkflowTestsUpdateOptions());
...
public final class Example {
  public static void main(String[] args) throws Exception {
    ...
    var result = client.workflows().tests().update("test_abc123", "Invoice Processing", null, null);
