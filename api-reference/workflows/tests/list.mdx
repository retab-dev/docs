...
# All tests
curl -X 'GET' \
  'https://api.retab.com/v1/workflows/wf_abc123xyz/tests?limit=50' \
  -H 'accept: application/json' \
  -H 'Api-Key: <your-api-key>'

# Filtered by target block
curl -X 'GET' \
  'https://api.retab.com/v1/workflows/wf_abc123xyz/tests?target_block_id=block_extract_invoice&limit=20' \
  -H 'accept: application/json' \
  -H 'Api-Key: <your-api-key>'
```
