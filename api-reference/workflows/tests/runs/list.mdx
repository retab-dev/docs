...
public final class Example {
  public static void main(String[] args) throws Exception {
    ...
    var result = client.workflows().tests().runs().list("wf_abc123", "test_abc123", null, null, null, null, null, null, "created_at", null, null, 10L, null);
...
```curl cURL
curl -X 'GET' \
  'https://api.retab.com/v1/workflows/tests/runs?workflow_id=wf_abc123xyz&status=completed&limit=10' \
