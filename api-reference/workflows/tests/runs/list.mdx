...
openapi: 'GET /v1/workflows/{workflow_id}/tests/{test_id}/runs'
---

List the most recent run records for a workflow test, newest first. Each entry is
...
```bash curl
curl -X 'GET' \
  'https://api.retab.com/v1/workflows/wf_abc123xyz/tests/wfnodetest_hsLEQiM61ez9Piv147MWk/runs?limit=10' \
