...
openapi: "POST /v1/workflows/tests/runs?workflow_id={workflow_id}"
---
...
Run Results](/api-reference/workflows/tests/runs/results/list), and [Get Test
Run Result](/api-reference/workflows/tests/runs/results/get).
...
# Single test
curl -X 'POST' \
  'https://api.retab.com/v1/workflows/tests/runs?workflow_id=wf_abc123xyz' \
