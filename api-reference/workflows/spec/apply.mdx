...
spec:
  ...
  edges: []
`
	result, err := client.Workflows.Spec.Apply(ctx, &retab.WorkflowSpecApplyParams{
...
use retab::resources::workflow_spec::ApplyParams;
use retab::Retab;
...
$result = $client->workflows()->spec()->apply(
    yamlDefinition: $yamlDefinition,
);
print_r($result);
```
...
public final class Example {
  public static void main(String[] args) throws Exception {
    ...
    var result = client.workflows().spec().apply("metadata:\n  id: invoice-workflow\n");
