...
<ParamField query="include_request" type="boolean" default="true">
  Whether to include and restore the original request payload.
</ParamField>

<ParamField query="include_response" type="boolean" default="true">
  Whether to include and restore response payloads/documents.
</ParamField>

For lightweight polling, use `include_request=false&include_response=false`.
