...
<ParamField query="after" type="string">
  Job ID. Use the `last_id` from the previous response to get the next page.
</ParamField>
...
<ParamField query="workflow_block_id" type="string">
...
<ParamField query="filename_regex" type="string">
