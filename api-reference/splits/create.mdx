...
<ParamField body="subdocuments" type="array[Subdocument]" required>
  The labeled subdocuments to split the document into. Each entry has `name`, optional `description`, optional `partition_key`, optional `allow_overlap`, and `allow_multiple_instances`.
</ParamField>
