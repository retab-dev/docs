...
const result = await client.schemas.generate(["passport.jpeg"], "retab-small", undefined, undefined, 96);
```
...
var result = await client.Schemas.GenerateAsync(apiKey, new SchemasGenerateOptions());
