...
1. `POST /v1/workflows/tests/runs?workflow_id={workflow_id}` returns a run
   object immediately.
...
| Method   | Path                                                                 | Purpose                                                          |
| -------- | -------------------------------------------------------------------- | ---------------------------------------------------------------- |
| `POST`   | `/v1/workflows/tests?workflow_id={workflow_id}`                       | [Create](/api-reference/workflows/tests/create)                  |
| `GET`    | `/v1/workflows/tests?workflow_id={workflow_id}`                       | [List](/api-reference/workflows/tests/list)                      |
| `GET`    | `/v1/workflows/tests/{test_id}?workflow_id={workflow_id}`             | [Get](/api-reference/workflows/tests/get)                        |
| `PATCH`  | `/v1/workflows/tests/{test_id}?workflow_id={workflow_id}`             | [Update](/api-reference/workflows/tests/update)                  |
| `DELETE` | `/v1/workflows/tests/{test_id}?workflow_id={workflow_id}`             | [Delete](/api-reference/workflows/tests/delete)                  |
| `POST`   | `/v1/workflows/tests/runs?workflow_id={workflow_id}`                  | [Create Run](/api-reference/workflows/tests/runs/create)         |
...
| `GET`    | `/v1/workflows/tests/runs/{run_id}/results`                          | [List Results](/api-reference/workflows/tests/runs/results/list) |
| `GET`    | `/v1/workflows/tests/runs/{run_id}/results/{test_id}`                | [Get Result](/api-reference/workflows/tests/runs/results/get)    |
