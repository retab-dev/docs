...
1. `POST /v1/workflows/{wf}/tests/runs` returns a run object immediately.
...
| `POST` | `/v1/workflows/{wf}/tests/runs` | [Create Run](/api-reference/workflows/tests/runs/create) |
