...
**How It Works:**
1. Connect to an Extract or Formula node (schema is automatically inherited)
...
<Card title="Formula" icon="function-square" color="#6366f1">
...
See [Formulas Documentation](/workflows/Formulas) for the complete formula reference.
...
<AccordionGroup>
  ...
  <Accordion title="Add Formula nodes for calculations">
