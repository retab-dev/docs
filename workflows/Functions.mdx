...
<Note>
  ...
  response into the function block.
</Note>
...
Use `/tmp/` or `/data/` as the mount prefix. See [Workflow Tables](/workflows/tables)
for CSV upload rules, query APIs, validation, and more table examples.
...
- [Extraction](https://docs.retab.com/primitives/Extract) - Learn how to extract structured data, design schemas, add reasoning prompts, and inspect provenance
