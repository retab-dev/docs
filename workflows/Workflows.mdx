...
- **Logic nodes** - Conditional flows like Human-in-the-Loop, Function, If/Else routing, and API Call
...
3. **Function** nodes compute derived fields for each document type
