...
<Note>
The overlay supersedes the legacy v1 HIL decision endpoints (`/v1/workflows/runs/{run_id}/hil-decisions`). The legacy surface still works but is frozen — new integrations should use the overlay.
</Note>
