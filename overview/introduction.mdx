Retab is a document processing API for the age of AI.
...
<CardGroup cols={2}>
  ...
  <Card title={<div className="card-title">Workflows</div>} icon="diagram-project" href="https://retab.com/dashboard/workflows">
