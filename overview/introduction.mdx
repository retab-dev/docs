...
<a href="../api-reference/parses/create" target="_self" className="endpoint-link">/parses -></a>\
...
<a href="../api-reference/classifications/create" target="_self" className="endpoint-link">/classifications -></a>\
