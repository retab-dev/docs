...
<a
  href="../api-reference/parses/create"
  target="_self"
...
<a
  href="../api-reference/extractions/create"
  target="_self"
  className="endpoint-link"
>
  extract ->
...
<a
  href="../api-reference/edits/create"
  target="_self"
  className="endpoint-link"
>
  edit ->
...
<a
  href="../api-reference/splits/create"
  target="_self"
  className="endpoint-link"
>
  split ->
...
<a
  href="../api-reference/partitions/create"
  target="_self"
  className="endpoint-link"
>
  partition ->
...
<a
  href="../api-reference/classifications/create"
  target="_self"
  className="endpoint-link"
>
  classify ->
