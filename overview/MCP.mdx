...
| Tool                 | Use it to                                                                                                                                                              |
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `workflows_create`   | Create an empty workflow scaffold with a default start-document block.                                                                                                 |
...
| Tool                        | Use it to                                                                                                                                                                                                  |
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `workflows_runs_create`     | Run a workflow against `production`, `draft`, or a pinned version id. Inputs map start-document block ids to `file_id` strings (or `{download_url, filename}`) and `start_json` block ids to JSON objects. |
...
| `workflows_reviews_*`       | Reviews for gated block runs: list the queue, inspect `triggered_by`, append corrected versions, approve/reject an exact `version_id`, or wait for a gate to fire.                                         |
