...
$testRun = $client->workflows()->tests()->runs()->create(
    workflowId: 'wf_abc123',
    testId: 'test_abc',
);
$testRun = $client->workflows()->tests()->runs()->get($testRun->id);
$testResults = $client->workflows()->tests()->results()->list(runId: $testRun->id);
