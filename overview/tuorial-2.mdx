...
$response = $http->post('v1/processors', [
    'headers' => ['Authorization' => 'Bearer ' . getenv('RETAB_API_KEY')],
    'json' => [
        'name' => 'Invoice Processor',
        'model' => 'retab-small',
        'json_schema' => $invoiceSchema,
...
http.DefaultRequestHeaders.Add("Authorization", "Bearer " + Environment.GetEnvironmentVariable("RETAB_API_KEY"));
...
You can do so by sending an test request to your webhook endpoint using the automation test endpoints.
