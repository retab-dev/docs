...
The platform has a [playground](https://retab.dev/dashboardplayground) you can explore and use to get sample code.


<Tip>
  Find your API Key in the [dashboard settings](https://retab.dev/dashboard/settings).
</Tip>
...
<Steps>
  ...
  <Step title="Generate a Schema" stepNumber={2}>
    <CodeGroup>
      ...
      ```curl cURL
      curl https://api.retab.dev/v1/schemas/generate \
